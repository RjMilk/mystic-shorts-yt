...
echo "🚀 Запуск Mystic Shorts YT Backend..."
echo "====================================="
...
pip install fastapi uvicorn sqlalchemy psycopg2-binary pydantic python-multipart httpx aiofiles python-telegram-bot requests beautifulsoup4 cryptography python-dotenv schedule pytz pillow opencv-python pytesseract pysocks socksio
